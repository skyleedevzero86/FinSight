...
public class BoardFileJpaEntity {
    ...
    @ManyToOne(fetch = FetchType.LAZY, targetEntity = BoardJpaEntity.class)
    ...
    public BoardJpaEntity getBoard() { return board; }
    public void setBoard(BoardJpaEntity board) { this.board = board; }
