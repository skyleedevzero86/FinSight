...
public class PopupItemResponse {
    ...
    public static PopupItemResponse from(PopupItem d) {
        PopupItemResponse r = new PopupItemResponse();
        r.setId(d.getId());
        ...
        r.setVerticalPos(d.getVerticalPos());
        r.setWidthPos(d.getWidthPos());
        r.setVerticalSize(d.getVerticalSize());
        r.setWidthSize(d.getWidthSize());
        r.setNoticeBegin(d.getNoticeBegin());
        r.setNoticeEnd(d.getNoticeEnd());
        r.setStopTodayHide(d.getStopTodayHide());
        r.setNoticeActive(d.getNoticeActive());
