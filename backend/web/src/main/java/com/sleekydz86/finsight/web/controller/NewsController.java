...
public class NewsController {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('USER')")
    public ResponseEntity<ApiResponse<Newses>> getNewsList(@Valid NewsQueryRequest request) {
        try {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('USER')")
    public ResponseEntity<ApiResponse<PaginationResponse<Newses>>> searchNews(@Valid NewsSearchRequest request) {
        try {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('USER')")
    public ResponseEntity<ApiResponse<Newses>> getPopularNews(@RequestParam(defaultValue = "10") int limit) {
        try {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('USER')")
    public ResponseEntity<ApiResponse<Newses>> getLatestNews(@RequestParam(defaultValue = "10") int limit) {
        try {
